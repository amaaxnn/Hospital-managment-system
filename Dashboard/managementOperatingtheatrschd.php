<?php 
  ...
  $result=mysqli_query($con,"SELECT * FROM operating_room_schedules"); //this database selecting the table name
...
<div class="staff-table">
    <h1>OPERATING THEATER SCHEDULES MANAGING RECORD LIST</h1>
<button class="back-button3" style="margin-right:85%;"> 
   <a href="OperatingTheaterSchedule.php" style="text-decoration:none; color:white;">BACK</a>
</button>
            ...
            <table>
                ...
                ?>                    
                    <tr>
                        ...
                        <td><?php echo $row['Op_time']; ?></td>
                        <td><?php echo $row['Op_date']; ?></td>
                        <td>
                            <!-- update query -->
                            <button class="update-button1" role="button"> 
                                <a href="updateoperatingtheatersched.php?Operation_ID=<?php echo $row["Operation_ID"];?>" style="text-decoration:none; color:white">UPDATE</a>
                            </button>
                        </td>
                        <td> 
                            <!-- delete query -->
                            <button class="delete-button1" role="button" onclick="return checkDelete()">
                                <a href="DeleteOperatingtheatrschd.php?id=<?php echo $row['id']; ?>" style="text-decoration:none; color:white">DELETE</a>
                            </button>
                        </td>
                    </tr>
