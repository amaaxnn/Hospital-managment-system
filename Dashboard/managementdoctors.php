<?php 
  ...
  $result=mysqli_query($con,"SELECT * FROM doctors"); //this database selecting the table name
...
<div class="staff-table">
    <h1>DOCTORS MANAGING RECORD LIST</h1>
<button class="back-button3" style="margin-right:85%;"> 
   <a href="Doctors.php" style="text-decoration:none; color:white;">BACK</a>
</button>
            ...
            <table>
                ...
                ?>    
                    <tr>
                        ...
                        <td><?php echo $row['Doc_phneno']; ?></td>
                        <td style="color:#2196F3;"><?php echo $row['Docemail']; ?></td>
                        <td><?php echo $row['Docspecialist']; ?></td>
                        <td>
                            <!-- update query -->
                            <button class="update-button1" role="button"> 
                                <a href="updatedoctors.php?Doc_ID=<?php echo $row["Doc_ID"];?>" style="text-decoration:none; color:white">UPDATE</a>
                            </button>
                        </td>
                        <td> 
                            <!-- delete query -->
                            <button class="delete-button1" role="button" onclick="return checkDelete()"> 
                                <a href="Deletedoctors.php?id=<?php echo $row['id']; ?>" style="text-decoration:none; color:white">DELETE</a> 
                            </button>
                        </td>
                    </tr>
